...
document.getElementById("connuser").innerText = JSON.parse(xmlHttp.responseText).history.lastReadMessages;
document.getElementById("connuser").setAttribute("class","w3-hide");
} else {
document.getElementById("connnow").innerText = "Get it!";
document.getElementById("connuser").innerText = "JuegOStrower";
